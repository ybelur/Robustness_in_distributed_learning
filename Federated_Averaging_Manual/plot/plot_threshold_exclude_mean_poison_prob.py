...
file_paths = [
    f"../results/threshold_exclude_mean_0.5_prob_model_poison_7_clients/run_{i:02d}.csv"
    for i in range(100)
]
...
plt.title('Moving Average of Global Accuracy vs Rounds over several Trials (Threshold Exclude Mean Model Poisoning)')
plt.xlabel('Round')
plt.ylabel('Global Accuracy (Moving Average)')
plt.grid(True)
plt.legend([], [], frameon=False) 
plt.savefig("../figures/threshold_exclude_mean/7_clients/threshold_exclude_mean_0.5_model_poison_100_prob.png", dpi=300)
