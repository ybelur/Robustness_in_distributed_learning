...
# List of uploaded CSV files and their corresponding poison levels
file_paths = [
    f"../results/median_prob_data_poison_7_clients/median_data_poison_cx3_run_{i:02d}.csv"
    for i in range(100)
]
...
plt.savefig("../figures/median/7_clients/median_data_poison_100_prob.png", dpi=300)
