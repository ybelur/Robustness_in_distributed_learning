...
# List of uploaded CSV files and their corresponding poison levels
file_paths = [
    f"../results/mean_model_poison/mean_model_poison_cx3_run_{i:02d}.csv"
    for i in range(100)
]
...
plt.title('Moving Average of Global Accuracy vs Rounds over several Trials (Mean Model Poisoning)')
plt.xlabel('Round')
plt.ylabel('Global Accuracy (Moving Average)')
plt.grid(True)
plt.legend([], [], frameon=False) 
plt.savefig("../figures/mean/10_clients/mean_model_poison_100_prob.png", dpi=300)
