...
plt.title("Moving Average of Global Accuracy vs Number of Rounds for Different Levels of Model Poisoning (Trimmed Mean Averaging - Trim Ratio 0.6)")
plt.xlabel("Number of Rounds")
plt.ylabel("Moving Average of Global Accuracy")
plt.legend(title="Number of Poisoned Nodes", bbox_to_anchor=(1, 1), loc='upper left')
plt.tight_layout()
plt.savefig("../figures/trimmed_mean/trimmed_mean_moving_avg_model_poison_10_clients_0.6.png", dpi=300)
# plt.show()
