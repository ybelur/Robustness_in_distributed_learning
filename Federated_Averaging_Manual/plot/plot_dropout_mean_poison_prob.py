...
# List of uploaded CSV files and their corresponding poison levels
file_paths = [
    f"../results/dropout_mean_0.4_prob_data_poison_batch/dropout_mean_data_poison_cx3_run_{i:02d}.csv"
    for i in range(100)
]
...
plt.savefig("../figures/dropout_mean_0.4_data_poison_100_prob.png", dpi=300)
